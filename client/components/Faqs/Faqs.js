...
const Faqs = () => {
  ...
  const [faqs, setFaqs] = useState([
    ...
    },
    {
      ...
      answer:
        'The starter code that you based on your selected tech stack will be created as a new repository in your Github account.',
      open: false,
    },
    {
      question: 'Can I use without a Github?',
      answer:
        'As we will be creating a new repository in your account, we will need access to your Github account for authentication.',
      open: false,
    },
  ]);
  ...
  return (
    <div className="faqs-wrapper">
      ...
      <div className="faqs">
        {faqs.map((faq, i) => (
          <FaqOpen key={i} faq={faq} index={i} toggleFAQ={toggleFAQ} />
        ))}
      </div>
    </div>
  );
